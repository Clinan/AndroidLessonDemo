package cn.edu.hdu.lessontest14.listener;
...
import cn.edu.hdu.lessontest14.MainActivity;
import cn.edu.hdu.lessontest14.R;
import cn.edu.hdu.lessontest14.StaffDAO;
...
public class TableViewListener implements ITableViewListener {
    ...
    public TableViewListener(MainActivity mainActivity) {
        ...
        new AlertDialog.Builder(tableView.getContext())
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        StaffDAO.updateStaff(contentResolver, staff);
