...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SQLiteOpenHelper dbHelper = new MySQLiteHelper(this, null, 1);
        ...
        //将数据插入到数据库，判断是有数据
        List<Staff> staffList = DbUtil.selectAllStaff(db);
        if (staffList.size() == 0) {
            Staff staff = new Staff();
            staff.setAll(0, "Tom", "male", "computer", 5400);
            DbUtil.insertStaff(db, staff);
            ...
            staff.setAll(4, "Napoleon", "male", null, 0);
            DbUtil.insertStaff(db, staff);
            staffList = DbUtil.selectAllStaff(db);
        }
    ...
    public ArrayList<String> toArrayList(Staff staff) {
